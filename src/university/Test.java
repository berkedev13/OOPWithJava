...
public class Test {
	...
	public static void main(String[] args) {
        ...
        Classroom classroom1 = new Classroom("E-101", course1, course1.students, course1.department, course1.teacher);
            ...
            System.out.println("Classroom Department: " + classroom1.getDepartment().name);
            System.out.println("Classroom Professor: " + classroom1.getProfessor().name);
            System.out.println("Classroom student: " + classroom1.getStudents()[0].name);
